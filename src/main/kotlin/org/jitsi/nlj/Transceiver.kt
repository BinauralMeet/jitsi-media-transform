...
class Transceiver(
    ...
    fun receivesSsrcs(): Set<Long> = streamInformationStore.receiveSsrcs
    fun receiveSsrcsByMediaType(): MutableMap<MediaType, MutableSet<Long>> =
        streamInformationStore.receiveSsrcsByMediaType
